...
- If start time is missing or unclear, set startTime and endTime to null, set missingStartTime to true, and add a warning with code MISSING_START_TIME.
...
- code: one of INFERRED_DATE, DEFAULT_DURATION, MISSING_START_TIME, LOW_CONFIDENCE, MULTIPLE_POSSIBLE_TIMES
